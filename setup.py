...
if platform.system() == "Windows":  # do the real build for Windows
...
else:  # build the interfaces so that MacOS and Linux can do static analysis of Windows targets
